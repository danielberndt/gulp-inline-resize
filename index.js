    ...
    function(cb) {
      ...
      Q.all(gmPromises).then(
        ...
        Object.keys(CACHE).forEach(function(cacheKey) {
          var cacheEntry = CACHE[cacheKey];
          if (cacheEntry.iteration + maxCacheAge < iteration) {
...
retVal.setMaxCacheAge = function(val) {
  maxCacheAge = val;
}

retVal._getCache = function() {return CACHE;} // for testing only!
